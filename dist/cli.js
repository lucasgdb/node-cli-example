...
function _promptForMissingOptions() {
  _promptForMissingOptions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options) {
...
function parseArgumentsIntoOptions(rawArgs) {
  ...
  return promptForMissingOptions({
...
function _cli() {
  _cli = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(args) {
    var options;
